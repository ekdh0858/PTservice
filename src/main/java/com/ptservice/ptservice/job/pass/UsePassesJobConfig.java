...
import com.ptservice.ptservice.repository.booking.BookingEntity;
import com.ptservice.ptservice.repository.booking.BookingRepository;
import com.ptservice.ptservice.repository.booking.BookingStatus;
...
public class UsePassesJobConfig {
    ...
    public Step usePassesStep() {
        return this.stepBuilderFactory.get("usePassesStep")
                .<com.ptservice.ptservice.repository.booking.BookingEntity, Future<com.ptservice.ptservice.repository.booking.BookingEntity>>chunk(CHUNK_SIZE)
    ...
    @Bean
    public AsyncItemProcessor<com.ptservice.ptservice.repository.booking.BookingEntity, com.ptservice.ptservice.repository.booking.BookingEntity> usePassesAsyncItemProcessor() {
        AsyncItemProcessor<com.ptservice.ptservice.repository.booking.BookingEntity, com.ptservice.ptservice.repository.booking.BookingEntity> asyncItemProcessor = new AsyncItemProcessor<>();
    ...
    @Bean
    public AsyncItemWriter<com.ptservice.ptservice.repository.booking.BookingEntity> usePassesAsyncItemWriter() {
        AsyncItemWriter<com.ptservice.ptservice.repository.booking.BookingEntity> asyncItemWriter = new AsyncItemWriter<>();
    ...
    public ItemWriter<BookingEntity> usePassesItemWriter() {
        return bookingEntities -> {
            for (com.ptservice.ptservice.repository.booking.BookingEntity bookingEntity : bookingEntities) {
                // 잔여 횟수를 업데이트 합니다.
